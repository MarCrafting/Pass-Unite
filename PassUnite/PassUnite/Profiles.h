...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Profiles::typeid));
			...
			this->pictureBoxProfiles->Click += gcnew System::EventHandler(this, &Profiles::pictureBoxProfiles_Click);
			// 
			// pictureBoxSettings
			// 
			...
			this->pictureBoxSettings->Click += gcnew System::EventHandler(this, &Profiles::pictureBoxSettings_Click);
			// 
			...
			this->pictureBoxAddProfile->Click += gcnew System::EventHandler(this, &Profiles::pictureBoxAddProfile_Click);
			// 
			// panelTopbar
			// 
			...
			this->labelAppName->Click += gcnew System::EventHandler(this, &Profiles::labelAppName_Click);
			// 
			// labelTitle
			// 
